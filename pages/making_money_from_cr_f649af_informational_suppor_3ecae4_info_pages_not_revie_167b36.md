...
show_ads: true
description: A support page loses trust when it behaves like a review before it has compared, tested or justified any recommendation.
hero_summary: A support page loses trust when it behaves like a review before it has compared, tested or justified any recommendation.
layout: default
...
page_heading_title: When should information not become a review?
source_count: 56
infographic_count: 3
planned_sections:
...
prev_link:
  ...
  heading_title: Which questions create buying momentum?
header:
  og_image: /assets/images/making_money_from_cr_f649af_informational_suppor_3ecae4_info_pages_not_revie_167b36-Illustration-1-social.jpg
  preview_image: /assets/images/making_money_from_cr_f649af_informational_suppor_3ecae4_info_pages_not_revie_167b36-Illustration-1.webp
image: /assets/images/making_money_from_cr_f649af_informational_suppor_3ecae4_info_pages_not_revie_167b36-Illustration-1-social.jpg
---
...
The mistake many affiliate sites make is treating every informational keyword as a hidden commercial keyword. The result is content that answers a question for two paragraphs and then suddenly introduces product [tables]({{ 'tables/' | relative_url }}) with little justification.
...
For example, a page titled "What does IP68 mean?" can explain water-resistance ratings, testing standards, and practical [limitations]({{ 'limitations/' | relative_url }}). It does not automatically follow that the page should recommend phones, watches, headphones, or cameras.
...
The informational page clarifies [criteria]({{ 'criteria/' | relative_url }}).
...
* condenser vs heat pump [comparisons]({{ 'comparisons/' | relative_url }})
...
### Link to categories rather than products
